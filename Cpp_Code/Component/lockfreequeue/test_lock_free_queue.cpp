...
static int s_queue_item_num = 200000; // 每个线程插入的元素个数
static int s_producer_thread_num = 5;  // 生产者线程数量
...
// g++ -o test_lock_free_queue test_lock_free_queue.cpp -lpthread  -std=c++11
