...
int ntyThreadPoolCreate(nThreadPool *workqueue, int numWorkers) {
    ...
    memcpy(&workqueue->jobs_cond, &blank_cond, sizeof(blank_cond));

    pthread_mutex_t blank_mutex = PTHREAD_MUTEX_INITIALIZER;
    memcpy(&workqueue->jobs_mtx, &blank_mutex, sizeof(blank_mutex));
...
void ntyThreadPollQueue(nThreadPool *workqueue, nJob *job) {
...
int main(int argc, char *argv[]) {
    ...
    ntyThreadPoolCreate(&poll, KING_MAX_THREAD);
