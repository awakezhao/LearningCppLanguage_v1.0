...
// 编译 g++ -o 2-test_log4cpp 2-test_log4cpp.cpp -llog4cpp -lpthread
int main(int argc, char *argv[]) {
    ...
    log4cpp::Category &warn_log =
        log4cpp::Category::getInstance("zhaoyun");   // 是一个单例工厂
    ...
    // 记录一些日志
    warn_log.info("Program info which cannot be wirten, zhaoyun = %d", 100);
    warn_log.warn("Program info which cannot be wirten, zhaoyun = %d", 100);
    warn_log.debug("This debug message will fail to write");
    warn_log.alert("Alert info");
    // 其他记录日志方式
    warn_log.log(log4cpp::Priority::WARN, "This will be a logged warning, zhaoyun = %d", 100);
    warn_log.warnStream() << "This will be a logged warning, zhaoyun = " << 100;
